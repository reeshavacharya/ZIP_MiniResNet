...
X_raw = np.array(acts["res1_conv2_input"], dtype=np.float64)
Wgt = np.array(params["res1_conv2.weight"], dtype=np.float64)
b = np.array(params["res1_conv2.bias"], dtype=np.float64)
...
print(f"[res1_conv2] multiplications logged: {mul_count}")
print(f"[res1_conv2] additions       logged: {add_count}")
