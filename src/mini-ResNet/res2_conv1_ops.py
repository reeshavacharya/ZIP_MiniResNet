...
X_raw = np.array(acts["res2_conv1_input"], dtype=np.float64)
Wgt = np.array(params["res2_conv1.weight"], dtype=np.float64)
b = np.array(params["res2_conv1.bias"], dtype=np.float64)
...
print(f"[res2_conv1] multiplications logged: {mul_count}")
print(f"[res2_conv1] additions       logged: {add_count}")
